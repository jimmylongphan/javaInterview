 ...
 * Tags: count, lists, google foobar
 *
 ...
 * but only she knows how to figure out which of several lists contains the access
 ...
 * in order to help her better find them in the lists. A "lucky triple" is a tuple
 * (x, y, z) where x divides y and y divides z, such as (1, 2, 4).
 * With that information, you can figure out which list contains the number of
 * access codes that matches the number of locks on the door when you're ready
 ...
 * and counts the number of "lucky triples" of (li, lj, lk) where the list
 * indices meet the requirement i < j < k.  The length of l is between 2 and
 * 2000 inclusive.  The elements of l are between 1 and 999999 inclusive.
...
public class AccessCodes {
    /**
     * Time: O(n^3) conditional
     * No need for 0 check
     *
     * @param l list of input
